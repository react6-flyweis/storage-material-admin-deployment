...
export default function LeadChatTab({ lead }: Props) {
  ...
  }, [socket, isConnected, actualLeadId]);
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col overflow-hidden min-h-[500px] max-h-[700px]">
      ...
      {/* Chat Messages Area */}
      <div className="flex-1 overflow-y-auto px-6 py-4 flex flex-col relative bg-gray-50/50">
        {isLoading ? (
