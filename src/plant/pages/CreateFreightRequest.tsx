          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex">
                ...
                <select
                  disabled={isEditing}
                  className="h-11 px-4 border border-l-0 border-gray-200 rounded-r-md bg-white text-gray-700 text-sm focus:outline-none"
                >
                  <option>Lbs</option>
                  <option>Kg</option>
                </select>
            ...
            <div className="space-y-1.5">
              ...
              <select
                disabled={isEditing}
                className="w-full h-11 px-3 border border-gray-200 rounded-md bg-white text-gray-700 text-sm focus:outline-none"
              >
