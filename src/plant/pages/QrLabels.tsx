      ...
      <Card className="shadow-sm border-gray-100 rounded-xl overflow-hidden">
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-[#f8fafc] text-gray-700 font-semibold border-b">
              <tr>
                ...
                <th className="px-6 py-5">QR Generated Date ⇅</th>
                <th className="px-6 py-5">Total QR Labels ⇅</th>
                ...
                <tr key={row.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-5 text-right">
                    <Button variant="ghost" size="icon" asChild className="hover:bg-gray-100 text-gray-700">
                      <Link to={`/plant/qr-labels/${row.id}`}>
        ...
        <div className="p-4 border-t bg-white flex items-center justify-between text-sm text-gray-600">
          ...
          <div className="flex items-center gap-1">
            ...
            <Button variant="ghost" size="sm" className="w-8 h-8 p-0 bg-[#f97316] text-white hover:bg-orange-600 hover:text-white rounded-full shadow-sm">4</Button>
