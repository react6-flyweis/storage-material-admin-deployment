...
import { ArrowLeft, ChevronDown, UploadCloud, X, Info, Eye, FolderUp } from "lucide-react";
    ...
    <div className="flex-1 space-y-6 p-6 md:p-8 bg-[#f4f7fb] min-h-screen font-sans max-w-[1200px] mx-auto w-full">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button className="bg-[#3b82f6] hover:bg-blue-600 text-white rounded-md font-medium px-4 py-2 flex items-center h-10 shadow-sm">
          <Eye className="w-4 h-4 mr-2" /> Add Shipper
        </Button>
      </div>
          ...
          {carrierOpen && (
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              <div className="space-y-2">
                ...
                <Input className="h-11 border-gray-200" defaultValue="Steel Shippers Inc." />
              </div>
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-gray-900">Shippers ID (Auto-generated + Editable) <span className="text-red-500">*</span></label>
                <Input className="h-11 border-gray-200" defaultValue="SHP-2026-10482" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-gray-900">Years of working with company</label>
                <Input className="h-11 border-gray-200" defaultValue="3 years" />
              </div>
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-gray-900">Service Category</label>
                <Select defaultValue="cm">
                  <SelectTrigger className="h-11 border-gray-200"><SelectValue /></SelectTrigger>
                  <SelectContent><SelectItem value="cm">Construction Material</SelectItem></SelectContent>
                </Select>
              </div>
            </div>
          )}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {addressOpen && (
            <div className="p-6">
              ...
              {/* Map Preview Area */}
              <div>
                <h4 className="font-bold text-gray-900 mb-3 text-[15px]">Map Preview</h4>
            ...
            <div className="flex-1">
              <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center justify-between shadow-sm max-w-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold text-sm text-gray-900 mb-0.5">MeterialDocument.pdf</div>
