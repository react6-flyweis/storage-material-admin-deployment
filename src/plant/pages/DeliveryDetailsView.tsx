        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-[#6A7282] shrink-0 font-medium mt-0.5">
              {delivery.deliveryNumber || deliveryId || "—"} - {delivery.formDetails?.description || delivery.deliveryInformation?.description || "—"}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-3">
        ...
        <div className="space-y-4">
          ...
          <DeliveryContacts
            ...
            deliveryId={delivery.deliveryNumber || deliveryId || ""}
