...
export default function FollowUpTemplateDialog({
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      // If backend says duplicate or mentions title/message, display under respective field or as general
      const lower = errorMsg.toLowerCase();
      if (lower.includes("duplicate") || (lower.includes("title") && lower.includes("already exists"))) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className={`text-xs h-9 ${errors.title ? "border-red-500 focus-visible:ring-red-500" : ""}`}
            />
            {errors.title && (
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              className={`text-xs resize-none ${errors.message ? "border-red-500 focus-visible:ring-red-500" : ""}`}
            />
            {errors.message && (
